...
export default function PrivacyPolicy(){
  return <>
    <PageHero eyebrow="Legal" title="Privacy Policy" text="How we collect, use and safeguard information shared with Farsight Advisory."/>
    <section className="section"><Container className="legal privacy-policy">
      ...
      {"Website refers to FARSIGHT ADVISORY, accessible from "}<a href="https://farsightadvisory.in">{"farsightadvisory.in"}</a>{"."}
      </li><li>
      ...
      <ul><li>
      {"By email: "}<a href="mailto:info@farsightadvisory.in">info@farsightadvisory.in</a>
      </li></ul>
      <p>{"Generated using "}<a href="https://www.termsfeed.com/privacy-policy-generator/">{"TermsFeed Privacy Policy Generator"}</a></p>
    </Container></section>
  </>;
}
